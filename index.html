...
<head>
    ...
    <!-- Babel CDN (untuk transpilasi JSX di browser) -->
...
<body>
    ...
    <script type="text/babel">
        ...
        // --- REPLIKASI IKON LUCIDE SEBAGAI KOMPONEN REACT ---
        // Karena kita tidak bisa mengimpor 'lucide-react', kita buat komponen SVG sendiri
        const Icon = ({ name, size = 24, className = '' }) => {
            const icons = {
                FilePlus: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>,
                LayoutDashboard: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>,
                ...
                ArrowRight: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>,
                LoaderCircle: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>,
                AlertTriangle: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>,
            ...
            const SvgComponent = icons[name] || icons.X;
        ...
        function LandingPage({ navigate }) {
            return (
                <div className="flex flex-col items-center justify-center min-h-screen p-8 text-center">
                    ...
                    >
                        Mulai Sekarang <Icon name="ArrowRight" size={20} />
                    </button>
                </div>
            );
        }
                ...
                <div className="flex items-center justify-center min-h-screen p-4">
                    <div className="w-full max-w-md bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-2xl border border-gray-700">
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            ...
                            >
                                {isLoading ? <Icon name="LoaderCircle" className="animate-spin" size={20} /> : 'Login'}
                            </button>
                        </form>
                    </div>
                </div>
                    ...
                    <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                        ...
                        <div className="flex items-center gap-4 mt-4 md:mt-0">
                            <button onClick={() => setIsModalOpen(true)} className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 transition-colors">
                                <Icon name="FilePlus" size={18} /> Tambah Pesanan
                            </button>
                    ...
                    <main className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-2xl shadow-2xl border border-gray-700">
                        ...
                        {isLoading ? (
                            <div className="flex justify-center items-center py-20">
                                <Icon name="LoaderCircle" className="animate-spin text-indigo-400" size={48} />
                            </div>
                        ) : (
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                            ...
                            <div className="flex justify-end gap-4 pt-4">
                                ...
                                <button type="submit" disabled={isLoading} className="px-6 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 transition-colors flex items-center gap-2">
                                     {isLoading ? <Icon name="LoaderCircle" className="animate-spin" size={20} /> : 'Simpan'}
                                </button>
                            </div>
                        </form>
                    </div>
        ...
        // Render aplikasi React ke dalam elemen root di HTML
